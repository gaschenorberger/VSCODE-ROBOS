            ...
            if debitoDetal == True:
                ...
                while True:
                    try:
                        ...
                        print(f'{dataApuracao} | {dataVencimen} | {valorDeb} | {valorRemanes} | {multaMora} | {naturezaDeb} | {formaConstitui}')
                        dados.append([numInscricao,cnpjEmpresa,nomeEmpresa,dataInscricao,receitaDivida,numProceAdmin,SitInscricao,natDivida,valPrincipal,valMulta,valJuros,valEncargo,valTotal,dataApuracao,dataVencimen,valorDeb,valorRemanes,multaMora,naturezaDeb,formaConstitui,'','','','','','','','', '', '', '', '','', '', '', '', '', '',''])
            ...
            if pagDetal == True:
                ...
                while True:
                    try:
                        ...
                        print(f'{dataArrecadPag} | {dataRecepPag} | {valRecolhidoPag} | {bancoAgenciaPag} | {NumCredPag} | {tipoCredPag} | {numPagamentoPag} | {numSendaPag}')
                        dados.append([numInscricao,cnpjEmpresa,nomeEmpresa,dataInscricao,receitaDivida,numProceAdmin,SitInscricao,natDivida,valPrincipal,valMulta,valJuros,valEncargo,valTotal,'','','','','','','',dataArrecadPag,dataRecepPag,valRecolhidoPag,bancoAgenciaPag,NumCredPag,tipoCredPag,numPagamentoPag,numSendaPag, '', '','', '','', '', '', '', '', '',''])
                        x += 1
                    except TimeoutException:
                        break
            ...
            if debitoDetal == True:
                ...
                while True:
                    try:
                        ...
                        dados.append([numInscricao,cnpjEmpresa,nomeEmpresa,dataInscricao,receitaDivida,'',SitInscricao,natDivida,valPrincipal,valMulta,valJuros,valEncargo,valTotal,'','','','','','','','','','','','','','','',estabelecimento,competencia,valorItem,saldoDevedor,situacao,'', '', '', '', '',''])
            ...
            if pagDetal == True:
                ...
                while True:
                    try:
                        ...
                        print(f'{dataArrecad} | {dataApropri} | {valAprop} | {refencia} | {numGuia} | {tipoCred}')
                        dados.append([numInscricao,cnpjEmpresa,nomeEmpresa,dataInscricao,receitaDivida,'',SitInscricao,natDivida,valPrincipal,valMulta,valJuros,valEncargo,valTotal,'','','','','','','','','','','','','','','','','','','','',dataArrecad,dataApropri,valAprop,refencia,numGuia,tipoCred])
                        x += 1
                    except TimeoutException:
                        break
